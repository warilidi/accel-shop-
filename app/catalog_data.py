        ...
        "items": [
            {
                ...
                "products": [
                    ...
                    p("[ACC] 🤖 ChatGPT Plus 1m (W10D)", 4, "ACC"),
            ...
            },
            {
                "name": "Cursor",
                "products": [
                    p("[Оф подписка] ✴️ Cursor Pro 1m", 36, "Оф подписка"),
                    p("[Оф подписка] ✴️ Cursor Pro+ 1m", 77, "Оф подписка"),
                    p("[Оф подписка] ✴️ Cursor Ultra 1m", 230, "Оф подписка"),
                    p("[Оф подписка] ✴️ Cursor Teams 1m", 77, "Оф подписка"),
                    p("[ACC] ✴️ Cursor Pro 1m", 22.5, "ACC"),
                    p("[ACC] ✴️ Cursor Edu Pro 12m", 34, "ACC"),
                    p("[ACC] ✴️ Cursor Pro 1m", 20, "ACC"),
                    p("[ACC] ✴️ Cursor Ultra 1m", 200, "ACC"),
                    p("[ACC] ✴️ Cursor Ultra 1m (NW)", 145, "ACC"),
                ],
            },
            {
                "name": "Suno AI",
        ...
        "items": [
            {
                ...
                "products": [
                    ...
                    p("[Приглашение] ✴️ Spotify Family 1m", 3.5, "Приглашение"),
                    p("[Приглашение] ✴️ Spotify Family 3m", 7, "Приглашение"),
                    p("[Приглашение] ✴️ Spotify Family 6m", 13, "Приглашение"),
                    p("[Приглашение] ✴️ Spotify Family 12m", 18, "Приглашение"),
                    p("[На ваш акк] ✴️ Spotify Family 1m", 7, "На ваш акк"),
                ],
            },
            {
                "name": "Netflix",
                "products": [
                    p("[ACC] ✴️ Netflix Premium 4K 1m", 3, "ACC"),
                    p("[ACC] ✴️ Netflix Premium 4K 3m", 7, "ACC"),
                    p("[ACC] ✴️ Netflix Premium 4K 6m", 13.5, "ACC"),
                    p("[ACC] ✴️ Netflix Premium 4K 12m", 18.5, "ACC"),
                ],
            },
            ...
            },
            {
                ...
                "products": [
                    ...
                    p("[E-Mail] ✴️ Adobe Creative 3m on your E-Mail", 12, "E-Mail"),
                ],
            },
